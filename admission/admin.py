...
from .models import SchoolYear, AdmissionPeriod, Program, Quota, AutoAdmission, Criteria, AdmissionRole, Department, AcademicRank, DocumentaryRequirement, InterviewSlot, Faculty
